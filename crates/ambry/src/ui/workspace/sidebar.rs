//! The table-list sidebar (`src/app/components/sidebar`). Selecting a table
//! runs `WorkspaceState::select_table`, which resets the data-tab state.

use gpui::prelude::*;
use gpui::{div, px, Context, SharedString, Window};
use guise::prelude::*;

use crate::ui::state::WorkspaceState;
