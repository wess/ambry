//! SQL preview for the change-review modal (`grid/changes.tsx` `generateSql`).
//! Display-only: the actual writes go through the host's row ops on commit.

use serde_json::Value;

use crate::types::Row;
use crate::ui::state::PendingChange;
