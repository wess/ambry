//! The insert-row modal (`grid/insertmodal.tsx`). One field per column; an
//! empty field is omitted so the column takes its database default. Emits the
//! assembled row for the Data panel to persist.
        ...
        Modal::new()
            ...
            .child(
                Group::new()
                    ...
                    .child(
                        Button::new("insert-submit", "Insert")
